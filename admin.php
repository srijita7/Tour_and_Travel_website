        ...
        <div class="home-content">
            ...
            <div class="sales-boxes">
                <div class="recent-sales box">
                    <div class="title">Last 5 Bookings</div>
                    <div class="sales-details">
                        <table class="center table table-striped table-bordered">
                            ...
                            <?php
                            $result = mysqli_query($conn, "SELECT * FROM book ORDER BY order_date DESC LIMIT 5");
                    ...
                    <div class="button">
                        <a href="adminbook.php">See All</a>
                    </div>
                </div>
                <div class="top-sales box">
                    ...
                    <ul class="top-sales-details">
                        <table class="center table table-striped table-bordered">
                            ...
                            <?php
                            $result = mysqli_query($conn, "select location, count(*) as count from book group by location order by count(*) desc");
                            $rows = mysqli_num_rows($result);
                            if ($rows == 0) {
