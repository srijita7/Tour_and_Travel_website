...
<body>
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="adminbook.php" class="active">
                        ...
                        <tbody>
                            ...
                            if ($rows == 0) {
                                ...
                                while ($res = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                    ...
                                    echo "<td><a href=\"admindelete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><button button type='button' class='account-btn btn btn-danger'>Delete</button></a></td>";
                                }
                            }
