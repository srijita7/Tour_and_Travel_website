...
<body>
  ...
  <div class="heading">
    <h1 style="color: var(--colorMain);">Register</h1>
  </div>
  <?php include('error.php'); ?>
  <div class="container">
    <form method="post" action="register.php" class="form-styling" id="register-form">
      ...
      <div class="inputBox">
        ...
        <input type="text" class="form-control" pattern="^[A-Za-z0-9_]+" name="username" value="<?php echo $username; ?>">
      </div>
      <div class="inputBox">
        <span>Email</span>
      ...
      <div class="inputBox">
        ...
        <input type="tel" class="form-control" pattern="^\d{10}$" name="contact" value="<?php echo $contact; ?>">
      </div>
      <div class="inputBox">
        <span>Password</span>
        ...
        <input type="password" class="form-control" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!_%*?&])[A-Za-z\d@$_!%*?&]{8,}$" name="password_1" value="<?php echo $password_1; ?>">
      </div>
      <div class="inputBox">
        <span>Confirm Password</span>
        <input type="password" class="form-control" name="password_2" value="<?php echo $password_2; ?>">
      </div>
      <div class="inputBox">
        <button type="submit" class="form-control btn" name="reg_user">Register</button>
      </div>
      <div class="inputBox">
        <p class="help-block">
